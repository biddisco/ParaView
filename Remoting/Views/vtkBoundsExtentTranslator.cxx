...
//----------------------------------------------------------------------------
vtkBoundsExtentTranslator::~vtkBoundsExtentTranslator() = default;
...
void vtkBoundsExtentTranslator::ShallowCopy(vtkBoundsExtentTranslator* trans)
{
  ...
  std::memcpy(this->Extent, trans->Extent, sizeof(int) * 6);
  std::memcpy(this->WholeExtent, trans->WholeExtent, sizeof(int) * 6);
  //
  ...
  std::memcpy(this->WholeBounds, trans->WholeBounds, sizeof(double) * 6);
  std::memcpy(this->Spacing, trans->Spacing, sizeof(double) * 3);
}
...
//----------------------------------------------------------------------------
void vtkBoundsExtentTranslator::ExchangeBoundsForAllProcesses(
  vtkMultiProcessController* controller, double localbounds[6])
{
...
void vtkBoundsExtentTranslator::SetBoundsForPiece(int piece, double* bounds)
{
  ...
  std::memcpy(&this->BoundsTable[piece * 6], bounds, sizeof(double) * 6);
}
...
void vtkBoundsExtentTranslator::SetBoundsHaloForPiece(int piece, double* bounds)
{
  ...
  std::memcpy(&this->BoundsTableHalo[piece * 6], bounds, sizeof(double) * 6);
}
...
void vtkBoundsExtentTranslator::SetUserBoundsForPiece(int piece, double* bounds)
{
  ...
  std::memcpy(&this->BoundsTableUser[piece * 6], bounds, sizeof(double) * 6);
}
...
void vtkBoundsExtentTranslator::InitWholeBounds()
{
  ...
  wholeBounds.GetBounds(this->WholeBounds);
}
...
void vtkBoundsExtentTranslator::GetBoundsForPiece(int piece, double* bounds)
{
  ...
  std::memcpy(bounds, &this->BoundsTable[piece * 6], sizeof(double) * 6);
}
...
void vtkBoundsExtentTranslator::GetBoundsHaloForPiece(int piece, double* bounds)
{
  ...
  std::memcpy(bounds, &this->BoundsTableHalo[piece * 6], sizeof(double) * 6);
}
  ...
  double* bounds, int* wholeExtent, int* resultExtent)
{
  ...
  double dims[3] = { static_cast<double>(wholeExtent[1] - wholeExtent[0]),
    static_cast<double>(wholeExtent[3] - wholeExtent[2]),
  ...
  {
    resultExtent[i * 2 + 0] =
      scaling[i] > 0 ? static_cast<int>(0.5 + (minpt[i] - origin[i]) / scaling[i]) : 0;
    resultExtent[i * 2 + 1] =
      scaling[i] > 0 ? static_cast<int>(0.5 + (maxpt[i] - origin[i]) / scaling[i]) : 0;
  }
  return 1;
}
//----------------------------------------------------------------------------
int vtkBoundsExtentTranslator::PieceToExtentThreadSafe(int piece, int numPieces, int ghostLevel,
