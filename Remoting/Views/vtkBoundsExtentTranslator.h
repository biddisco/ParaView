...
#ifndef vtkBoundsExtentTranslator_h
#define vtkBoundsExtentTranslator_h
...
class VTKREMOTINGVIEWS_EXPORT vtkBoundsExtentTranslator : public vtkExtentTranslator
{
public:
  ...
  virtual int BoundsToExtentThreadSafe(double* bounds, int* wholeExtent, int* resultExtent);
...
protected:
  ...
  ~vtkBoundsExtentTranslator() override;
...
private:
  vtkBoundsExtentTranslator(const vtkBoundsExtentTranslator&) = delete;
  void operator=(const vtkBoundsExtentTranslator&) = delete;
};
